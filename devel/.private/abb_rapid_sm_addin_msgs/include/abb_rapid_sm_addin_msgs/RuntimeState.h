...
struct RuntimeState_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::abb_rapid_sm_addin_msgs::StateMachineState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::abb_rapid_sm_addin_msgs::StateMachineState_<ContainerAllocator> >::other >  _state_machines_type;
