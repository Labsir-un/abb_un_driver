...
struct StateMachineState_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _rapid_task_type;
...
struct Printer< ::abb_rapid_sm_addin_msgs::StateMachineState_<ContainerAllocator> >
{
  ...
  {
    s << indent << "rapid_task: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.rapid_task);
    s << indent << "sm_state: ";
