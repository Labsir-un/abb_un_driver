...
struct WObjData_
{
  ...
  _ufprog_type ufprog;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _ufmec_type;
  _ufmec_type ufmec;
...
struct Printer< ::abb_rapid_msgs::WObjData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::abb_rapid_msgs::WObjData_<ContainerAllocator>& v)
  {
    ...
    s << indent << "ufmec: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.ufmec);
    s << indent << "uframe: ";
    s << std::endl;
