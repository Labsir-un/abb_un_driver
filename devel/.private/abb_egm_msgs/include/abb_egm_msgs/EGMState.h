...
struct EGMState_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::abb_egm_msgs::EGMChannelState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::abb_egm_msgs::EGMChannelState_<ContainerAllocator> >::other >  _egm_channels_type;
