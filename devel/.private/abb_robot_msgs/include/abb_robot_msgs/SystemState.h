...
struct SystemState_
{
  ...
  _rapid_running_type rapid_running;
   ...
   typedef std::vector< ::abb_robot_msgs::RAPIDTaskState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::abb_robot_msgs::RAPIDTaskState_<ContainerAllocator> >::other >  _rapid_tasks_type;
  _rapid_tasks_type rapid_tasks;

   typedef std::vector< ::abb_robot_msgs::MechanicalUnitState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::abb_robot_msgs::MechanicalUnitState_<ContainerAllocator> >::other >  _mechanical_units_type;
